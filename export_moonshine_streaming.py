"""
Export UsefulSensors/moonshine-streaming-small (safetensors) to ONNX + INT8.

Produces in ./moonshine_streaming_small_onnx/:
...
OUTPUT_DIR      = Path("moonshine_streaming_small")
...
# Small model dims (from config.json)
NUM_DECODER_LAYERS = 10
DECODER_HEADS = 8
HEAD_DIM = 64        # 512 hidden / 8 heads
ENC_HIDDEN = 620     # raw encoder output dim (decoder adapter projects this to 512 internally)
